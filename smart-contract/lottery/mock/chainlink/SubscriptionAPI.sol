...
import {EnumerableSet} from "@chainlink/contracts/v0.8/vendor/openzeppelin-solidity/v4.7.3/contracts/utils/structs/EnumerableSet.sol";
...
import {IERC677Receiver} from "@chainlink/contracts/v0.8/shared/interfaces/IERC677Receiver.sol";
import {IVRFSubscriptionV2Plus} from "@chainlink/contracts/v0.8/vrf/dev/interfaces/IVRFSubscriptionV2Plus.sol";

abstract contract SubscriptionAPI is
    ConfirmedOwner,
    IERC677Receiver,
    IVRFSubscriptionV2Plus
{
    ...
    function requestSubscriptionOwnerTransfer(
        ...
        SubscriptionConfig storage subscriptionConfig = s_subscriptionConfigs[
            subId
        ];
